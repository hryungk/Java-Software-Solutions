//********************************************************************************
//  RationalNumber.java      Author: Hyunryung Kim
//
...
public class RationalNumber implements Comparable<RationalNumber>
{
    ...
    //----------------------------------------------------------------------------
    //  Compares two floating point values and returns an integer value.
    //----------------------------------------------------------------------------
    public int compareTo(RationalNumber op2)
    {
        int result;
        double num1 = (double)numerator / denominator;
        double num2 = (double)op2.getNumerator() / op2.getDenominator();
        if (num1 < num2)
            result = -1;
        else
